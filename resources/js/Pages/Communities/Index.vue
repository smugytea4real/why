              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                <tr v-for="communities in communities.data" :key="communities.id">
                  ...
                  <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                    <Link :href="route('communities.edit', communities.slug)" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</Link>
                    <Link :href="route('communities.destroy', communities.slug)" class="text-red-600 hover:text-red-900" method="delete" as="button" type="button">Delete</Link>
                  </td>
                </tr>
